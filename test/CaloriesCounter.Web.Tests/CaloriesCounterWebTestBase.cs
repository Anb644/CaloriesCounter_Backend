...
using CaloriesCounter.Web.Startup;
using AngleSharp.Html.Dom;
using AngleSharp.Html.Parser;
using Microsoft.AspNetCore.Hosting;
using Shouldly;

namespace CaloriesCounter.Web.Tests
{
    public abstract class CaloriesCounterWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CaloriesCounterWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CaloriesCounterWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CaloriesCounterDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CaloriesCounterDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CaloriesCounterDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CaloriesCounterDbContext, Task<T>> func)
        {
            T result;
